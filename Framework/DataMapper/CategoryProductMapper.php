...
class CategoryProductMapper extends DataMapper
{
    ...
    public function addProductToCategory(CategoryProduct $categoryProduct): void
    {
        $paramToDb = [];
        $paramToQuery = [];
        $valueToQuery = [];
        $param = [
            $this->transformToDbFormat('categoryId') => $categoryProduct->getCategoryId(),
            $this->transformToDbFormat('productId') => $categoryProduct->getProductId(),
        ];
    ...
    public function updateProductInCategory(CategoryProduct $categoryProduct): void
    {
        $paramToDb = [];
        $paramToQuery = [];
        $param = [
    ...
    public function deleteProductFromCategory(CategoryProduct $categoryProduct): void
    {
