<section class="product mb-5" id="product">
    ...
    <div class="product-inner d-flex justify-content-between align-items-center">
        ...
        <div class="product-info">
            <p class="product-price" align="center">Price: $</p>
            <p class="product-amount" align="center">In stock:</p>
...
<section class="description">
    <div class="description-inner">
        ...
        <p class="description-title" align="justify"></p>
    </div>
</section>
